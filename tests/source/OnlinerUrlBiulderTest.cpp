...
TEST(OnlinerUrlBuilder, BuildUrlFromValidConfig_Round)
{
    Onliner::UrlBuilder builder;
    Telegram::User::Config config;
...
TEST(OnlinerUrlBuilder, BuildUrlFromValidConfig_Clamp)
{
    Onliner::UrlBuilder builder;
    Telegram::User::Config config;

    string expectedLink = "https://r.onliner.by/ak/?rent_type%5B%5D=1_room&rent_type%5B%5D=2_rooms&rent_type%5B%5D=3_rooms&price%5Bmin%5D=50&price%5Bmax%5D=10000&currency=usd&only_owner=true#bounds%5Blb%5D%5Blat%5D=53.8&bounds%5Blb%5D%5Blong%5D=27.39&bounds%5Brt%5D%5Blat%5D=54.01&bounds%5Brt%5D%5Blong%5D=27.72&page=1";
